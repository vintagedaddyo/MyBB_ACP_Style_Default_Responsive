...
//]]>
    ...
    function output_footer($quit=true)
	{
        ...
        echo "            <br>";
        echo "            Powered By <a href=\"http://www.mybb.com/\" target=\"_blank\">MyBB</a>, &copy; 2002-".COPY_YEAR." <a href=\"http://www.mybb.com/\" target=\"_blank\">MyBB Group</a>. <br /> Style By: <a href=\"http://community.mybb.com/user-6029.html\">Vintagedaddyo</a> &amp; <a href=\"http://www.chack1172.altervista.org\">Chack1172</a>.\n";
        echo "            <br>";
        echo "          </div>\n";
        echo "          <div class=\"clearfix\"></div>\n";
        echo "        </footer>\n";
...
EOF;
		...
		$login_page .= <<<EOF
                ...
                <div class="separator">
                    <br>
                    <a href="../index.php"><h1><i class="fas fa-comments"></i> MyBB!</h1></a>
                    <p>Powered By <a href="https://www.mybb.com/" target="_blank">MyBB</a>, &copy; 2002-{$copy_year} <a href="https://www.mybb.com/" target="_blank">MyBB Group</a>..<br /> Style By: <a href="http://community.mybb.com/user-6029.html">Vintagedaddyo</a> &amp; <a href="http://www.chack1172.altervista.org/?language=english">Chack1172</a>. <br /></p>
                </div>
            </form>
        </section>
	</div>
